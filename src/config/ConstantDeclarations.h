...
DECLARE_DOUBLE(conveyorCoeffA, 0.0000)
DECLARE_DOUBLE(conveyorCoeffB, 0.0000)
DECLARE_DOUBLE(conveyorCoeffC, 0.0000)
DECLARE_DOUBLE(conveyorCoeffD, 1.0000)
...
DECLARE_DOUBLE(conveyorKP, 1.0)
DECLARE_DOUBLE(conveyorKI, 0.0)
DECLARE_DOUBLE(conveyorKD, 0.0)

// Shooter constants
DECLARE_DOUBLE(minConveyorBallDist, 100.0)
DECLARE_DOUBLE(conveyorPIDThreshold, 100.0)
DECLARE_DOUBLE(conveyorHeight, 10.0)
DECLARE_DOUBLE(conveyorIntakeBuffer, 10.0)
DECLARE_DOUBLE(conveyorPIDIncrement, 10.0)
