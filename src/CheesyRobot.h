...
#ifndef ROBOT_CHEESY_H_
#define ROBOT_CHEESY_H_

#include "Timer.h"
#include "RobotBase.h"

/**
 * CheesyRobot implements a specific type of Robot Program framework, extending the RobotBase class.
 * 
 * The CheesyRobot class is intended to be subclassed by a user creating a robot program.
 * 
